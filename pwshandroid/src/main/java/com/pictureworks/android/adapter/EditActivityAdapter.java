...
public class EditActivityAdapter extends BaseAdapter {
    ...
    public EditActivityAdapter(Context context, Bitmap bitmap, List<String> stickerPathList, int editType, ArrayList<FrameOrStikerInfo> frameInfos, String appType, Handler handler) {
...
//			System.out.println(position + " ---->" + frameInfos.get(position).frameThumbnailPath160);
     ...
     * @author bauer_bao
     */
    private class DownloadDialogOnClickListener implements DialogInterface.OnClickListener {
        private HolderView holderView;
        private int position;
