...
package com.pictureworks.android.zxing.camera;
...
final class FlashlightManager {
  ...
  static {
    ...
    if (iHardwareService == null) {
      PictureAirLog.d(TAG, "This device does supports control of a flashlight");
    } else {
      PictureAirLog.d(TAG, "This device does not support control of a flashlight");
    }
  }
  ...
  private static Class<?> maybeForName(String name) {
    try {
      ...
      PictureAirLog.d(TAG, "Unexpected error while finding class " + name + re.toString());
      return null;
    }
  }
  ...
  private static Method maybeGetMethod(Class<?> clazz, String name, Class<?>... argClasses) {
    try {
      ...
      PictureAirLog.d(TAG, "Unexpected error while finding method " + name + re);
      return null;
    }
  }
  ...
  private static Object invoke(Method method, Object instance, Object... args) {
    try {
      ...
      PictureAirLog.d(TAG, "Unexpected error while invoking " + method + e);
      return null;
    } catch (InvocationTargetException e) {
      PictureAirLog.d(TAG, "Unexpected error while invoking " + method + e.getCause());
      return null;
    } catch (RuntimeException re) {
      PictureAirLog.d(TAG, "Unexpected error while invoking " + method + re);
      return null;
    }
  }
