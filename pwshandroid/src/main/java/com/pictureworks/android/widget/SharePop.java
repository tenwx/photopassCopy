...
public class SharePop extends PopupWindow implements OnClickListener,
    ...
    public SharePop(Context context, String tokenId) {
        super(context);
...
//            shareParams.setUrl(shareUrl);
    ...
    public void onClick(View v) {
        ...
        int i = v.getId();
        if (i == R.id.wechat_moments || i == R.id.wechat || i == R.id.qq || i == R.id.qqzone || i == R.id.sina || i == R.id.facebook || i == R.id.twitter) {
...
//				} else {
            if ("local".equals(type)) {//开始分享
                ...
                API1.getShareUrl(tokenId, photoId, shareFileType, v.getId(), mHandler);
            }

        } else if (i == R.id.share_cancel) {
            dialog.dismiss();
            ShareSDK.stopSDK();
                ...
                ImageLoader.getInstance().loadImage("file:///" + imagePath,
                        new ImageLoadingListener() {
                            ...
                            public void onLoadingComplete(String imageUri,
                                ...
                                if (id == R.id.twitter) {// 生成缩略图成功， 需要开始分享
        ...
        switch (msg.what) {
            case MSG_ACTION_CCALLBACK: {
                switch (msg.arg1) {
                    case 1: {
                        // 成功
                        API1.shareCallBack(tokenId, shareId, sharePlatform);
