	...
	private Handler handler = new Handler(){
		public void handleMessage(Message msg) {
			...
			case LOAD_SELECTED_IMAGE_FOR_NO_PRODUCT_IMAGE://只显示照片的处理方式
				ViewGroup.LayoutParams params = onlySelectedImageView.getLayoutParams();
			...
			case LOAD_SELECTED_IMAGE://加载选择的图片，普通商品
				...
				LayoutParams params3 = new LayoutParams(previewPhotoW, previewPhotoH);
				//设置左边距和上边距
			...
			case LOAD_SELECTED_IMAGE_FOR_MUG_CASE://杯子的mask层
				...
				LayoutParams params2 = new LayoutParams(previewPhotoW2, previewPhotoH2);
				//设置左边距和上边距
