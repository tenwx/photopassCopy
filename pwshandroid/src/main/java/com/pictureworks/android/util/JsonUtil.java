...
import com.pictureworks.android.entity.HelpInfo;
...
//                    }
     ...
     * 解析优惠卷的json
     */
    public static List<CouponInfo> getCouponListFromJson(JSONObject jsonObject, String language) {
        ...
        for (int i = 0; i < array.size(); i++) {
            list.add(getCouponInfo(array.getJSONObject(i), language));
        }
        return list;
    }
     ...
     * 解析成功即可
     */
    public static List<CouponInfo> getCouponListFromJson2(JSONObject jsonObject, String language) {
     ...
     * @return
     */
    public static CouponInfo getCouponInfo(JSONObject jsonObject, String language) throws JSONException {
        ...
        boolean isCn = language.equals("zh");
