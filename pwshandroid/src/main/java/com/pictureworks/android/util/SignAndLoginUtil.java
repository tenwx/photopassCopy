...
public class SignAndLoginUtil implements Handler.Callback {
    ...
    private String name, birthday, gender, country, tokenId, appType;
    ...
    public SignAndLoginUtil(Context c, String account, String pwdStr, boolean isSign, boolean needModifyInfo,
                            String name, String birthday, String gender, String country, String appType, OnLoginSuccessListener onLoginSuccessListener) {
        this.context = c;
        ...
        switch (msg.what) {
            ...
            case API1.GET_TOKEN_ID_SUCCESS://获取tokenId成功
                ...
                if (isSign) {
                    ...
                    API1.Login(context, tokenId, account, pwd, handler);
                }
                break;
            ...
            case API1.UPDATE_PROFILE_SUCCESS:
                ...
                API1.getCarts(tokenId, sp.getString(Common.LANGUAGE_TYPE, null), null, handler);
                break;
            ...
            case API1.GET_CART_SUCCESS://获取购物车成功
                ...
                //获取StoreId
                API1.getStoreId(tokenId, handler);
                break;
    ...
    private void start() {
        ...
        tokenId = AESKeyHelper.decryptString(sp.getString(Common.USERINFO_TOKENID, null), PWJniUtil.getAESKey(appType));
