...
public class Common {
	...
	// "http://pictureAir.cloudapp.net:3001";//美国服务器
	// public static final String BASE_URL =
	...
	// public static final String PHOTO_URL =
	// "http://191.236.87.204:4000/";//美国服务器
	// public static final String PHOTO_URL =
	// "http://pictureAir.cloudapp.net:4000/";//美国服务器
	// public static final String PHOTO_URL =
	// "http://140.206.125.194:4000/";//外网
	// 接口
	...
	public static final String GET_LASTEST_CONTENT = "/park/getLatestContent";// 获取最新更新的内容
	...
	public static final String ALIPAY_NOTIFY = "http://140.206.125.194:3001/shopping/notify_url";// alipay的异步通知URL
	...
	public static final String BIND_PPS_DATE_TO_PPP = "/ppp/bindPPsAndBindDatesToPPP";// 将pp绑定到ppp
																						// 多了时间。
	...
	public static final String USER_PATH = Environment
	...
	public static final String PHOTO_DOWNLOAD_PATH = Environment
			.getExternalStorageDirectory().getPath() + "/pictureAir/download/";
	public static final String TEMPPIC_PATH = Environment
			.getExternalStorageDirectory().getPath() + "/pictureAir/temppic/";
	...
	// public static final String AUTO_BIND_PP =
	// "autobindpp";//购买ppp之后，是否需要自动绑定标记，photoid：表示需要自动绑定；其他：不需要自动绑定
	...
	// public static final String BARCODEURL =
	// "http://192.168.8.3:3001/downloadApp.html?";
	...
	// public static final String IS_BUYING_FROM_VIEWORSELECT =
	// "isBuyingFromViewOrSelect";
	// public static final String IS_BUYING_FROM_LOCATION =
	// "isBuyingFromLocation";
