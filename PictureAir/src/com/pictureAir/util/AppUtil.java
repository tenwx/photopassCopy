...
public class AppUtil {
	...
	public static double gps2m(double lat_a, double lng_a, double lat_b,
			double lng_b) {
		return DistanceUtil.getDistance(new LatLng(lat_a, lng_a), new LatLng(
				lat_b, lng_b));
	}
	 ...
	 * @return 转换后的经纬度
	 */
	public static LatLng converterFromGPS2BD(JSONObject obj)
	 ...
	 */
	public static String dateToSmartDate(String compareDate, Context context)
			throws ParseException {
		String result = null;
