		...
		public void handleMessage(Message msg) {
			...
			case API.MODIFY_PWD_FAILED:
				...
				if (msg.obj.toString().equals("errOldPwd")) {
					newToast.setTextAndShow(R.string.errOldPwd,
							Common.TOAST_SHORT_TIME);
				} else if (msg.obj.toString().equals("shortPassword")) {
					newToast.setTextAndShow(R.string.shortPassword,
							Common.TOAST_SHORT_TIME);
				} else if (msg.obj.toString().equals("userNotExist")) {
					newToast.setTextAndShow(R.string.userNotExist,
							Common.TOAST_SHORT_TIME);
				} else {
					newToast.setTextAndShow(R.string.failed,
							Common.TOAST_SHORT_TIME);
				}
