...
import com.pictureAir.adapter.CompositeImageProductAdapter;
 ...
 *
 */
@SuppressLint("NewApi") public class BannerView_PreviewCompositeProduct extends LinearLayout {
	...
	public void initImageList(ArrayList<PhotoInfo> list, String goodsUrl, int viewWidth, int viewHeight,
		...
		for (int i = 0; i < count; i++) {//加载图片
			...
			System.out.println("good name--------->"+ goodName);
				System.out.println("photo path--------->"+photopathString);
			//新建view
