            ...
            case R.id.button1://选择确定按钮
                ...
                if (photoURLlist.size() == 0) {
                    ...
                    if (activity.equals("detailproductactivity") || activity.equals("previewproductactivity")) {
                        ...
                        API1.uploadPhotoMakeVideo(MyApplication.getTokenId(), photos.toString(), selectPhotoHandler);
                        ...
                        API1.useExperiencePPP(MyApplication.getTokenId(), getIntent().getStringExtra("pppCode"), photoIds, selectPhotoHandler);
                    }
                }
                break;
            default:
