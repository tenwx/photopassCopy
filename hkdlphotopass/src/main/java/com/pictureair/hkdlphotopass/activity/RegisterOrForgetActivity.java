...
import com.pictureworks.android.util.RegisterTool;
...
import com.pictureworks.android.widget.CustomTextView;
...
public class RegisterOrForgetActivity extends BaseActivity implements RegisterOrForgetCallback, View.OnClickListener, TextWatcher {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerTool = new RegisterTool(tokenId, context, this, languageType, Common.APP_TYPE_HKDLPP);
        initView();
        initData();
    }
