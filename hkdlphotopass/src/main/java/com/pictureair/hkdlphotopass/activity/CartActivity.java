...
public class CartActivity extends BaseActivity implements OnClickListener {
    ...
    private void dealHandler(Message msg) {
        switch (msg.what) {
            ...
            case API1.UPLOAD_PHOTO_SUCCESS:
                ...
                API1.modifyCart(MyApplication.getTokenId(), cartItemInfo.getCartId(), cartItemInfo.getGoodsKey(), cartItemInfo.getQty(), embedPhotos, cartHandler, dialog);
            ...
            case NoNetWorkOrNoCountView.BUTTON_CLICK_WITH_RELOAD://noView的按钮响应重新加载点击事件
                ...
                API1.getCarts(MyApplication.getTokenId(), MyApplication.getInstance().getLanguageType(), null, cartHandler);
                cartInfoList.clear();
                break;
        ...
        switch (v.getId()) {
            ...
            case R.id.button3_pm://支付提交按钮
                ...
                if (isEdit) {
                    ...
                    //请求删除操作
                    API1.removeCartItems(MyApplication.getTokenId(), jsonArray, cartHandler);
    ...
    public void getDiscountPrice() {
        ...
        API1.getCarts(MyApplication.getTokenId(), MyApplication.getInstance().getLanguageType(), jsonArray, cartHandler);
