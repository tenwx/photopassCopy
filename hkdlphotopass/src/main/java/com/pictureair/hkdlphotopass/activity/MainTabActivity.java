...
import com.pictureair.hkdlphotopass.fragment.FragmentPageCamera;
...
import com.pictureworks.android.widget.dropview.CoverManager;
import com.pictureworks.android.widget.dropview.DropCover.OnDragCompeteListener;
import com.pictureworks.android.widget.dropview.WaterDrop;
 ...
 * 通过扫描或者登录之后会来到此页面
 */
public class MainTabActivity extends BaseFragmentActivity implements OnDragCompeteListener, Handler.Callback, CheckUpdateManager.DownloadListener {
    ...
    private void initView() {
        ...
        checkUpdateManager = new CheckUpdateManager(MyApplication.getInstance().getApplicationContext(), currentLanguage, MyApplication.getTokenId(), Common.APP_TYPE_HKDLPP,
                parentLayout, this);
