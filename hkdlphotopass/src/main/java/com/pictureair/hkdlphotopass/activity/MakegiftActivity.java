...
import com.pictureworks.android.adapter.MakegiftGoodsAdapter;
...
import com.pictureworks.android.widget.BannerView_PreviewCompositeProduct;
        ...
        switch (msg.what) {
            ...
            case API1.UPLOAD_PHOTO_SUCCESS:
                ...
                if (upload_index < photoList.size()) {
                    ...
                    API1.addToCart(MyApplication.getTokenId(), goodsInfo.getGoodsKey(), 1, isbuynow, embedPhotos, makeGiftHandler);
                }
                break;
...
//        selectButton.setOnClickListener(this);
        ...
        if (goodsByACache == null ||  goodsByACache.equals("")) {
            API1.getGoods(MyApplication.getTokenId(), MyApplication.getInstance().getLanguageType(), makeGiftHandler);
        } else {
            Message message = makeGiftHandler.obtainMessage();
