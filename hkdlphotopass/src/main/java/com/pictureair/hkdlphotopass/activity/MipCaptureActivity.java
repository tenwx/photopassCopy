...
import com.pictureworks.android.zxing.decoding.CaptureActivityHandler;
import com.pictureworks.android.zxing.decoding.InactivityTimer;
import com.pictureworks.android.zxing.decoding.OnDealCodeListener;
import com.pictureworks.android.zxing.view.ScanView;
    ...
    public void decodeSuccess(Result result, Bitmap bitmap) {
        if (dialog != null && dialog.isShowing()) {//不处理扫描结果
            ...
            if (resultString.equals("")) {
                ...
                dialog = CustomProgressDialog.show(this, getString(R.string.connecting), false, null);
                dealCodeUtil.startDealCode(code, Common.APP_TYPE_HKDLPP);
            }
...
//        tvCenterHint.setRotation(90);
        ...
        dealCodeUtil = new DealCodeUtil(this, getIntent(), false, MyApplication.getInstance().getLanguageType(), mipCaptureHandler);
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        if (handler == null) {
            handler = new CaptureActivityHandler(this, decodeFormats, characterSet, viewfinderView, scanType);
