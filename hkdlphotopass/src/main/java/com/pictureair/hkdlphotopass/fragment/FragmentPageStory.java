...
import com.pictureworks.android.entity.PhotoItemInfo;
import com.pictureworks.android.eventbus.BaseBusEvent;
import com.pictureworks.android.eventbus.MainTabSwitchEvent;
import com.pictureworks.android.eventbus.RedPointControlEvent;
import com.pictureworks.android.eventbus.SocketEvent;
import com.pictureworks.android.eventbus.StoryFragmentEvent;
import com.pictureworks.android.eventbus.StoryRefreshEvent;
import com.pictureworks.android.eventbus.StoryRefreshOnClickEvent;
...
import com.pictureworks.android.widget.viewpagerindicator.TabPageIndicator;
        ...
        switch (msg.what) {
            ...
            case LOAD_PHOTO_FROM_DB:
                if (photoPassPicList.size() == 0 || needfresh) {
                    ...
                    API1.getVideoList(MyApplication.getTokenId(), null, fragmentPageStoryHandler);//获取全部视频信息
                } else {
...
//                    app.setPushPhotoCount(0);
            ...
            case REFRESH://开始刷新
                ...
                API1.getVideoList(MyApplication.getTokenId(), sharedPreferences.getString(Common.LAST_UPDATE_VIDEO_TIME, null), fragmentPageStoryHandler);//获取最新视频信息
                API1.getSocketData(MyApplication.getTokenId(), fragmentPageStoryHandler);//手动拉取socket信息
                break;
            ...
            case SORT_COMPLETED_REFRESH:
                ...
                API1.getADLocations(MyApplication.getTokenId(), fragmentPageStoryHandler);
...
//        more = (TextView) view.findViewById(R.id.story_more);
        ...
        context = getActivity();
        pictureAirDbManager = new PictureAirDbManager(getActivity(), PWJniUtil.getSqlCipherKey(Common.APP_TYPE_HKDLPP));
