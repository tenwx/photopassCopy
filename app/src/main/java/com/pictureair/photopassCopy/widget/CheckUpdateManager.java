...
import com.pictureair.photopassCopy.entity.FileInfo;
import com.pictureair.photopassCopy.service.BreakpointDownloadService;
...
//        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {//7.0以及以上适配
            uri = FileProvider.getUriForFile(context, "com.pictureair.photopassCopy.udeskfileprovider", downloadAPKFile);
