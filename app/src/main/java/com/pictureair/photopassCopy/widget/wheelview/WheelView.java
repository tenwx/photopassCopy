...
package com.pictureair.photopassCopy.widget.wheelview;
...
import com.pictureair.photopassCopy.widget.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private int wheelBackground = R.color.white;//---------------------------------------------------------选中框的背景颜色--
...
//			System.out.println("items count = "+itemsLayout.getChildCount()+ "index = "+ index);
//			//设置字体颜色
//			textView1 = (TextView)itemsLayout.getChildAt(index);
//			if (textView1 != null) {
//				
//				textView1.setTextColor(R.color.gray);
//			}
//			textView2 = (TextView)itemsLayout.getChildAt(index - 1);
//			if (textView2 != null) {
//				
//				textView2.setTextColor(R.color.gray2);
//			}
//			textView3 = (TextView)itemsLayout.getChildAt(index + 1);
//			if (textView3 != null) {
//				
//				textView3.setTextColor(R.color.gray2);
//			}
...
//		int height = (int)(getItemHeight());
	...
	private void drawCenterRect(Canvas canvas) {
		...
		// 绘制第一根直线
		canvas.drawLine(getWidth()/3, center - offset * 3, getWidth()/3*2, center - offset * 3, paint);
		//绘制第二根直线
		canvas.drawLine(getWidth()/3, center - offset, getWidth()/3*2, center - offset, paint);
//		canvas.drawLine(0, center - offset, getWidth(), center - offset, paint);//横线充满整个屏幕
		// 绘制第三根直线
		canvas.drawLine(getWidth()/3, center + offset, getWidth()/3*2, center + offset, paint2);
