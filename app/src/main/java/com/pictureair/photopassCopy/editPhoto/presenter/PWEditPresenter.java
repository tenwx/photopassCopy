package com.pictureair.photopassCopy.editPhoto.presenter;
...
import com.pictureair.photopassCopy.adapter.EditActivityAdapter;
import com.pictureair.photopassCopy.editPhoto.filter.Filter;
import com.pictureair.photopassCopy.editPhoto.interf.IPWEditView;
import com.pictureair.photopassCopy.editPhoto.interf.PWEditViewListener;
import com.pictureair.photopassCopy.editPhoto.util.EditPhotoUtil;
import com.pictureair.photopassCopy.editPhoto.util.PWEditUtil;
import com.pictureair.photopassCopy.editPhoto.util.PhotoCommon;
...
//        API1.getLastContent(SPUtils.getString(MyApplication.getInstance(),Common.SHARED_PREFERENCE_APP,Common.GET_LAST_CONTENT_TIME,""), mHandler);
    ...
    private void onScanFinish(String file) {
        ...
        // 可以添加一些返回的数据过去，还有扫描最好放在返回去之后。
                pwEditView.getEditPhotView().setResult(11);
