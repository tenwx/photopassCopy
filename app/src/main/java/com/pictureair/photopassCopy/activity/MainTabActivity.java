...
import com.pictureair.photopassCopy.adapter.SlideListAdapter;
...
import com.pictureair.photopassCopy.fragment.FragmentPageDiscover;
import com.pictureair.photopassCopy.fragment.FragmentPageMe;
import com.pictureair.photopassCopy.fragment.FragmentPageShop;
import com.pictureair.photopassCopy.fragment.FragmentPageStory;
import com.pictureair.photopassCopy.greendao.PictureAirDbManager;
import com.pictureair.photopassCopy.http.rxhttp.HttpCallback;
...
import com.pictureair.photopassCopy.util.PPInfoSortUtil;
...
import com.pictureair.photopassCopy.widget.CheckUpdateListener;
import com.pictureair.photopassCopy.widget.CheckUpdateManager;
import com.pictureair.photopassCopy.widget.PWToast;
import com.pictureair.photopassCopy.widget.dropview.CoverManager;
import com.pictureair.photopassCopy.widget.dropview.DropCover.OnDragCompeteListener;
import com.pictureair.photopassCopy.widget.dropview.WaterDrop;
...
public class MainTabActivity extends BaseFragmentActivity implements OnDragCompeteListener, Handler.Callback,
    ...
    protected void onResume() {
        ...
        Intent intent1 = new Intent(this, com.pictureair.photopassCopy.service.NotificationService.class);
