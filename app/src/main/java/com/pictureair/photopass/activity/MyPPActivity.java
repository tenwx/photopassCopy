    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ok://确认绑定按钮
                ...
                API1.bindPPsDateToPPP(pps, dppp.PPPCode, mHandler);
    ...
    private void getPhotoUrlFromDatabase() {
        new Thread() {
            public void run() {
                ...
                mHandler.sendEmptyMessage(GET_SELECT_PP_SUCCESS);
            }
