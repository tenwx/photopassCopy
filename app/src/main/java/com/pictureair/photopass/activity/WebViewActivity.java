...
//            PictureAirLog.e("===","url:"+Common.BASE_URL_TEST + Common.IPAY_LINK + "?tokenId="+MyApplication.getTokenId()+"&orderId="+orderId+"&language=" + language +"&currency="+currency + "&appID="+appID);
