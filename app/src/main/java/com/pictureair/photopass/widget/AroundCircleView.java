...
public class AroundCircleView extends ImageView {
    ...
    private void setup() {
        ...
        mDrawableRect.set(mBorderWidth/2f, mBorderWidth/2f, mBorderRect.width()
                - mBorderWidth/2f, mBorderRect.height() - mBorderWidth/2f);

        mDrawableRadius = Math.min(mDrawableRect.height() / 2f,
