...
import com.pictureair.hkdlphotopass.adapter.DailyPPCardRecycleAdapter;
...
import com.pictureair.hkdlphotopass.widget.PPPPop;
import com.pictureair.hkdlphotopass.widget.PWToast;
import com.pictureair.hkdlphotopass.widget.RecycleTopDividerItemDecoration;
        ...
        API2.getLocationPhoto(MyApplication.getTokenId())
                .map(new Func1<JSONObject, ArrayList<DailyPPCardInfo>>() {
                    ...
                    public ArrayList<DailyPPCardInfo> call(JSONObject jsonObject) {
                        PictureAirLog.json("photos", jsonObject.toJSONString());
                        //更新数据库
